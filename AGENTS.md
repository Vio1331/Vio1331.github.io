...
- 首页：保留大标题与整屏章节节奏；文章主卡片在左、装饰「文」在右，摄影集完整封面在右、装饰「影」在左。按日期倒序展示一个摄影主封面和两条次条，不复用摄影列表封面。
- 文章列表页：文章以卡片形式排列。
- 文章详情页：使用居中的正文版式。
...
- 装饰「文」「影」使用 Dela Gothic One 的两字子集，描边与静态字形必须一致；Freeman 使用 OPTICS 子集。保留正文、标题字体与品牌字距，修改品牌名称时同步更新子集字符。
