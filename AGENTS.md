...
- 装饰字为「文」「图」，均使用 SVG 线条轮廓，动画结束不淡出、不填充。「文」取自 Dela Gothic One；因其缺少简体「图」，「图」取自 Noto Sans SC 900，并按相同可见高度等比缩放。字号和时间参数见基线末节。Freeman 继续使用 OPTICS 子集，正文、标题字体与品牌字距保持不变。
